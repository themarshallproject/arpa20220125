...
<div class="arpa-project-example-card-action">
  ...
  <CardText div class="graphic-source">
    Source: Spending data reported to the
      ...
      </a> The Marshall Project selected a sample of ARPA spending on criminal justice by conducting keyword searches on the project descriptions that local government wrote.
