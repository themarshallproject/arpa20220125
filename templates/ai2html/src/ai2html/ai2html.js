...
var tmpBaseSettings = {
        ...
        inline_svg: {defaultValue: "no", includeInSettingsBlock: false, includeInConfigFile: false, useQuoteMarksInConfigFile: false, inputType: "yesNo", possibleValues: "", notes: ""},
...
function generateOutputHtml(content, pageName, settings) {
  ...
  // comments
  commentBlock = "<!-- THIS DOCUMENT WILL BE OVERWRITTEN WHEN ai2html.js IS RUN -->\r<!-- EDIT AT YOUR OWN PERIL! -->\r<!-- Generated by ai2html v" + scriptVersion + " - " +
